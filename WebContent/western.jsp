...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
      ...
      <li class="nav-item">
        <a class="nav-link " href="western.jsp" id="westernbtn" style="font-family: myFont2"><h4>Western</h4></a>
      </li>
       <li class="nav-item">
...
<!-- ------------------------------------------------------------- SPORTS-->
	<%
		...
		int Id;
		ResultSet rs=st.executeQuery("select * from event where catogory = 'western';");
	%>	
	<div id="sports" class="page">
		<div class="jumbotron" style="background-color:#f8f9fa">
			<div align="center">
				<h1 style="font-family: myFont">WESTERN EVENTS</h1>
			</div>
		</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Subscribe to Western</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
