...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link" href="gaming.jsp" id="gamingbtn" style="font-family: myFont2"><h4>Gaming</h4></a>
      </li>
      <li class="nav-item">
...
<!-- ------------------------------------------------------------- SPORTS-->
	<%
		try{
			...
			int Id;
			ResultSet rs=st.executeQuery("select * from event where catogory = 'gaming';");
	%>	
	<div id="sports" class="page">
		<div class="jumbotron" style="background-color:#f8f9fa">
			<div align="center">
				<h1 style="font-family: myFont">GAMING EVENTS</h1>
			</div>
		</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Subscribe to gaming</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        	<form action="" enctype="multipart/form-data" method="post" >
			  ...
			  <div class="form-group">
			    <input type="password" class="form-control" id="catogory" aria-describedby="emailHelp"  name="catogory" value="gaming" hidden>
			  </div>
			  <div class="form-group">
