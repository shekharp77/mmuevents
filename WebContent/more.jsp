  ...
  <div class="collapse navbar-collapse" id="navbarText">
     <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link " href="more.jsp" id="morebtn" style="font-family: myFont2"><h4>More</h4></a>
      </li>
    </ul>
...
<!-- ------------------------------------------------------------- SPORTS-->
	<%
		...
		int Id;
		ResultSet rs=st.executeQuery("select * from event where catogory = 'more';");
	%>	
	<div id="sports" class="page">
		<div class="jumbotron" style="background-color:#f8f9fa">
			<div align="center">
				<h1 style="font-family: myFont">OTHER EVENTS</h1>
			</div>
		</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Subscribe to More</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        	<form action="" enctype="multipart/form-data" method="post" >
			  ...
			  <div class="form-group">
			    <input type="password" class="form-control" id="catogory" aria-describedby="emailHelp" value="more"  name="catogory" hidden>
			  </div>
			  <div class="form-group">
