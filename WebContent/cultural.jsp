  ...
  <div class="collapse navbar-collapse" id="navbarText">
     <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link active" href="sports.jsp" id="sportsbtn" style="font-family: myFont2"><h4>Sports</h4> </a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="cultural.jsp" id="culturalbtn" style="font-family: myFont2"><h4>Cultural</h4></a>
      </li>
      <li class="nav-item">
...
<!-- ------------------------------------------------------------- SPORTS-->
	<%
		...
		int Id;
		ResultSet rs=st.executeQuery("select * from event where catogory = 'cultural';");
	%>	
	<div id="sports" class="page">
		<div class="jumbotron" style="background-color:#f8f9fa">
			<div align="center">
				<h1 style="font-family: myFont">CULTURUL EVENTS</h1>
			</div>
		</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        	<form action="AdminServlet" enctype="multipart/form-data" method="post" >
			  ...
			  <div class="form-group">
			    <input type="password" class="form-control" id="" aria-describedby="emailHelp" placeholder="password" name="password">
			  </div>
			  <div class="form-group">
			    <input type="text" class="form-control" id="" aria-describedby="emailHelp" placeholder="Name" name="ftype" value="login" hidden>
			  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Subscribe to CulturalEvents</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        	<form action="" enctype="multipart/form-data" method="post" >
			  ...
			  <div class="form-group">
			    <input type="number" class="form-control" id="Phoneno" aria-describedby="emailHelp" placeholder="Phone no" name="phoneno">
			  </div>
			  <div class="form-group">
			    <input type="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="email" name="email">
			  </div>
			  <div class="form-group">
			    <input type="password" class="form-control" id="catogory" aria-describedby="emailHelp"  name="catogory" value="cultural" hidden>
			  </div>
			  <div class="form-group">
